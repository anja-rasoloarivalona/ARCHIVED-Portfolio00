...
$(function() {
 ...
 var writer = new TimelineMax({repeat:-1, repeatDelay: 2.58});
 //set d
 writer
 .to('.home__title__writer', 1.5, {x: -372})
 .to('.home__title__hide', 1.5, {x: 8},'-=1.5')
 .to('.home__title', 1.5, {x: '20%'},'-=1.5')
 .to('.home__title--2', .2, {opacity: 1})
 .to('.home__title--1', .2, {opacity: 0})
 .to('.home__title__writer', 1.5, {x: 0})
 .to('.home__title__hide', 1.5, {x: '100%'},'-=1.5')
 ...
 .to('.home__title__writer', 1.5, {x: 0})
 .to('.home__title__hide', 1.5, {x: 0},'-=1.5')
 .to('.home__title', 1.5, {x: '0%'},'-=1.5')
